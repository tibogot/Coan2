...
export default function HomeCard() {
  ...
  useGSAP(
    () => {
      ...
      const startPosition = isMobile ? "top 20%" : "top 35%";
      const endPosition = isMobile ? "top 20%" : "top 30%";
      const cardEndPosition = isMobile ? "top 80%" : "top 65%";
      const yOffset = isMobile ? 8 : 14; // Reduced stacking on mobile
    ...
    {
      scope: container,
      dependencies: [domReady, lenis, isMobile], // Add isMobile as dependency
    },
  );
